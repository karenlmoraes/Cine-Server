    ...
    return (
        ...
        <div className='flex flex-col '>
            <div className='mt-5 flex self-center  '>
                ...
                <input className='blogfilter' type="text" placeholder='...Pesquisar' 
                value={busca} onChange={(e) => setBusca(e.target.value)} class="border 
                                border-gray-300 shadow p-3 w-96 rounded mb-"/>
            </div>
