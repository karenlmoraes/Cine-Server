const Footer = () => {
    ...
    return (
        ...
        <footer className="flex flex-wrap flex-col items-center px-4 py-6 text-sm text-gray-700 border-t">
            <div className="text-center">© 2022  <a href="https://shuffle.dev/" className="text-gray-700 hover:underline" 
            ...
            <p className="w-full mt-2 mb-2 text-center text-gray-700">Tailwind Builder is a product of <a href="https://shuffle.dev/">Shuffle</a> and is not affiliated with Tailwind CSS or Tailwind Labs.</p>
